...
const history = require("./assets/23.jpg");
...
Am acumulat experiență în producția de confecții metalice</li>

            <li>și structuri metalice. Astfel putem produce o gamă foarte largă de produse metalice, majoritatea diferind de la un proiect la altul: platforme, balustrade, scări, garduri și porți (cu sau fără automatizare), vase de inox și recipienți industriali. Firma noastră asigură atât confecționarea cât și montajul structurilor produse, beneficiind de un personal cu îndelungată experiență în astfel de lucrări.</li>
          </ul>
